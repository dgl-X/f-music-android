...
Текущая версия: **1.0.26**. Клиент поддерживает выбор собственного HTTPS-сервера на странице входа, потоковое и офлайн-воспроизведение, персональные лайки и плейлисты, загрузку музыки, полноэкранный плеер, Media Session, управляемую очередь, диагностические отчёты и закрытую федеративную библиотеку.
...
- карточки альбомов используют стабильный идентификатор альбома;
- обложка, описание, год и исполнитель альбома загружаются независимо от тегов отдельных треков;
- сохранена совместимость с серверами без нового API альбомов.
...
cp app/build/outputs/apk/release/app-release.apk ../builds/f_music_v1.0.26.apk
```
