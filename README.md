...
Текущая версия: **1.0.24**. Клиент поддерживает выбор собственного HTTPS-сервера на странице входа, потоковое и офлайн-воспроизведение, персональные лайки и плейлисты, загрузку музыки, полноэкранный плеер, Media Session, управляемую очередь, диагностические отчёты и закрытую федеративную библиотеку.
...
cp app/build/outputs/apk/release/app-release.apk ../builds/f_music_v1.0.24.apk
```
